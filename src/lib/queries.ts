 ...
 * the counter should show on the dashboard without a reload, and the 10-second
...
export function useMarkPrinted(token: string) {
  ...
  return useMutation({
    ...
    // largest thing the Production page did after pressing Print. The 10-second
...
// the roster is a picture of right now. The app's own 10-second refresh tick
 ...
 * 10-second tick alongside the list would multiply this screen's traffic to
